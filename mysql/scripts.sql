...
CREATE TABLE `PhoneNumbers` (
    ...
    CONSTRAINT `FK_PhoneNumbers_Tariffs_TariffId` FOREIGN KEY (`TariffId`) REFERENCES `Tariffs` (`Id`) ON DELETE CASCADE
) CHARACTER SET utf8mb4;
...
INSERT INTO `Passports` (`Id`, `Series`, `Num`, `DateOfIssue`, `IssuingAuthority`, `Surname`, `Name`, `Patronymic`, `DateOfBirth`, `Address`) VALUES (NULL, '5555', '111111', '2021-12-01', 'МВД г. Владимира', 'Пупкин', 'Василий', 'Ильич', '2000-12-01', 'г. Владимир');
INSERT INTO `Passports` (`Id`, `Series`, `Num`, `DateOfIssue`, `IssuingAuthority`, `Surname`, `Name`, `Patronymic`, `DateOfBirth`, `Address`) VALUES (NULL, '9999', '444444', '2021-12-02', 'МВД г. Москва', 'Туткина', 'Зинаида', 'Олеговна', '2001-10-10', 'г. Москва');

INSERT INTO `Clients` (`Id`, `PassportId`) VALUES (NULL, '1');
INSERT INTO `Clients` (`Id`, `PassportId`) VALUES (NULL, '2');

INSERT INTO `Tariffs` (`Id`, `Name`, `Price`) VALUES (NULL, 'Тариф 1', '1.0');
INSERT INTO `Tariffs` (`Id`, `Name`, `Price`) VALUES (NULL, 'Тариф 2', '1.5');

INSERT INTO `PhoneNumbers` (`Id`, `ClientId`, `Num`, `TariffId`, `RegistrationDate`) VALUES (NULL, '1', '89005553535', '1', '2001-02-02');
INSERT INTO `PhoneNumbers` (`Id`, `ClientId`, `Num`, `TariffId`, `RegistrationDate`) VALUES (NULL, '2', '89057777777', '2', '2011-10-07');
